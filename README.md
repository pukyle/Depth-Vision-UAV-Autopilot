...
https://github.com/user-attachments/assets/13a5ece6-3228-490e-95d9-796d764f719d

<p align="center">
  <em><b>Left panel:</b> The AirSim simulation environment displaying the UAV's real-time flight status alongside dual-view camera feeds (depth map and RGB image). 
    <b>Top-right panel:</b> The control ROS Node terminal, handling real-time API communication and logging flight data along with depth matrix information. 
...
<p align="center">
  <img src="assets/images/RRT_comparison.jpg" width="100%" alt="Three RRT* variants with DWA trajectory tracking"/>
</p>
...
<table>
  <tr>
    <td align="center">
      <img src="assets/images/mean_turning_angle_comparison.jpg" width="100%" alt="Smoothness comparison"/>
      <br><em>Fig 2. Mean turning angle — DWA reduces oscillation across all variants.</em>
    </td>
    <td align="center">
      <img src="assets/images/path_length_comparison.jpg" width="100%" alt="Path length comparison"/>
...
<p align="center">
  <img src="assets/images/planning_time_comparison.jpg" width="50%" alt="Planning time comparison"/>
</p>
